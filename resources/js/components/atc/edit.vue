					...
					<div class="card">
						<div class="px-4 py-4">
							<div class="flex justify-between pb-2 mt-2 mb-2">
								<h4 class="font-bold m-0" >Schedule of Alphanumeric Tax Codes <small>Add New</small></h4>
							</div>
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										<label class="form-label">INCOME PAYMENTS SUBJECT TO EXPANDED WITHHOLDING TAX</label>
										<textarea class="form-control border" placeholder="-" rows="3"></textarea>
									</div>									
								</div>
							</div>
							<div class="row">
