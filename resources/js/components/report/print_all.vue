				...
				<page size="Legal" class="page-break">
					<div class="p-2 !relative text-center bg-gren-900">
						...
						<div class="first-quarter">
							...
							<span v-for="first in d.firstmonth"> {{ d.tax_type === "Vat" ? parseFloat(first.amount / 1.12).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,') : parseFloat(first.amount).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,') }} <br></span>
						</div>
						...
						<div class="second-quarter">
							<span v-for="second in d.secondmonth">{{ d.tax_type === "Vat" ? parseFloat(second.amount / 1.12).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,') : parseFloat(second.amount).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,') }}<br></span>
						</div>
						...
						<div class="third-quarter">
							<span v-for="third in d.thirdmonth">{{ d.tax_type === "Vat" ? parseFloat(third.amount / 1.12).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,') : parseFloat(third.amount).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,') }}<br></span>
						</div>
