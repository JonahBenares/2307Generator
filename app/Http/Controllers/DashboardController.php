    ...
    public function get_print_details($id){
        ...
        foreach($details AS $d){
            ...
            $data[] = [
                ...
                'original_subtotal_first'=>array_sum($subtotal_first),
                'subtotal_second'=>array_sum($subtotal_second),
                'original_subtotal_second'=>array_sum($subtotal_second),
                'subtotal_third'=>array_sum($subtotal_third),
                'original_subtotal_third'=>array_sum($subtotal_third),
                'subtotal'=>$subtotal,
                'grandtotal'=>number_format($grandtotal,2),
                'original_grandtotal'=>number_format($grandtotal,2),
                'tax'=>$tax,
                'totaltax'=>number_format($total_tax,2),
                'original_totaltax'=>number_format($total_tax,2),
